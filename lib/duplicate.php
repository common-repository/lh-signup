...
define( 'MUCD_MAX_NUMBER_OF_SITE', 5000 );
    ...
    require_once WP_PLUGIN_DIR . '/lh-signup/lib/files.php';
    require_once WP_PLUGIN_DIR . '/lh-signup/lib/data.php';
    require_once WP_PLUGIN_DIR . '/lh-signup/lib/log.php';
    require_once WP_PLUGIN_DIR . '/lh-signup/lib/option.php';
    require_once WP_PLUGIN_DIR . '/lh-signup/lib/functions.php';
